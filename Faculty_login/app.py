...
app.config.update(
    ...
    MAIL_PORT = 465,
    MAIL_USE_SSL = True,
    MAIL_USERNAME = 'yourcollege01@gmail.com',
    MAIL_PASSWORD = 'college@yours01',
    MAIL_DEFAULT_SENDER = 'yourcollege01@gmail.com'
    )
mail = Mail(app)
...
conn = MySQLdb.connect(host="localhost",user="root",password="7605909299",db="login_info")
...
if(__name__ == '__main__'):
    ...
    app.run(host='192.168.43.117',port=4545,debug=True)
    #192.168.31.186
    #192.168.43.117